         ...
         <div style="width:500px;">
            <div class="main animated zoomIn" v-cloak>
                <form  v-on:submit.prevent="submit()">
                    ...
                    <button class="btn btn-lg btn-primary btn-block" type="submit"  id="sub"  style="width:300px;height: 50px;"    > 提交</button> 
...
<script>
  ...
  mounted(){
        ...
        methods: {
            //提交登入
            submit(){
                this.$axios.post("http://127.0.0.1/user/addoneuser",this.user)
                .then(function(response){
   
                     window.location.href="http://127.0.0.1:8080/user/AdminManagement";
                }).catch(res =>{
                    alert("服务器繁忙，稍后在尝试");
                }) 
            },
